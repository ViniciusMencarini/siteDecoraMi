...
<?php // Footer for all the pages minus Index   ?>
...
<div class="container">
    <footer class="py-3 my-4 border-top">
        <ul class="nav justify-content-center pb-3 mb-3 custom-hover">
            ...
            <li class="nav-item"><a href="./contact.php" class="nav-link px-2 text-white">CONTATO</a></li>
            <li class="nav-item"><a href="./legal.php" class="nav-link px-2 text-white">USO E
                    PRIVACIDADE</a>
            </li>
                    ...
                    <div class="d-flex justify-content-between py-2 my-2 text-white">
                        ...
                        <ul class="list-unstyled d-flex">
                            <li class="ms-3"><a class="link-light"
                                    href="https://www.instagram.com/decorami_atelier/"><svg class="bi" width="24"
                                        height="24" fill='#fff'>
                                        <use xlink:href="#instagram" />
                                    </svg></a></li>
                            <li class="ms-3"><a class="link-light" href="https://www.facebook.com/decoramiatelier/"><svg
                                        class="bi" width="24" height="24" fill='#fff'>
